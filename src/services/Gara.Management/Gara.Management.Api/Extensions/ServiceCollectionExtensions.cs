...
namespace Gara.Management.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddRepositories(this IServiceCollection services)
        {
            ...
            services.AddScoped<IRepository<AppointmentScheduleDetail>, EfRepository<GaraManagementDBContent, AppointmentScheduleDetail>>();
            ...
            services.AddScoped<IRepository<Bill>, EfRepository<GaraManagementDBContent, Bill>>();
